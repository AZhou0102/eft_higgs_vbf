...
class VBFProcessor(processor.ProcessorABC):
    def __init__(self, isMC=False, ewkHcorr=False, systematics=False):
        ...
        self.make_output = lambda: { 
            ...
            "bin1_nom_sumw": processor.value_accumulator(float),
            "bin2_nom_sumw": processor.value_accumulator(float),
            "bin1_scalevar_3ptUp_sumw": processor.value_accumulator(float),
            "bin2_scalevar_3ptUp_sumw": processor.value_accumulator(float),
            "bin1_scalevar_3ptDown_sumw": processor.value_accumulator(float),
            "bin2_scalevar_3ptDown_sumw": processor.value_accumulator(float),
        }
    ...
    def process(self, events):
       ...
       #ew correction diagnostics
        ...
        if syst in systematics:
            print('systematics are included')
        else:
        ...
        output["bin1_nom_sumw"] += y1_nom
        output["bin2_nom_sumw"] += y2_nom
        ...
        for systematic in ["scalevar_3ptUp", "scalevar_3ptDown"]:
            ...
            output[f"bin1_{systematic}_sumw"] += y1
            output[f"bin2_{systematic}_sumw"] += y2
            print(systematic,
        ...
        try:
            ...
            names = weight_names("/uscms/home/azhou/nobackup/smeft/cmseft/generation/genproductions/bin/MadGraph5_aMCatNLO/cards/VBF_SMEFTsim_topU3l_NP1/VBF_SMEFTsim_topU3l_NP1_reweight_card.dat")
